...
BOHR_ANGST=0.52917721067121
# (conversion ref: 2018 CODATA NIST)
...
# Job specifications for SPE (Force) and Hessian calculations
spejob = "#"+" "+spelevel
gradjob = "#"+" "+gradlevel+" "+"force"
hessjob = "#"+" "+hesslevel+" "+"freq=noraman"
...
if runfreq and hesslevel == gradlevel:
    runforce = False
if runfreq and hesslevel == spelevel:
    runspe = False
if runforce and gradlevel == speleve:
    runspe = False

# ^ Above can be abbreviated to:

#runpse = runforce = runfreq = True

#if deriv == 2:
#    if hesslevel == gradlevel:
#        runforce = False
#    if hesslevel == spelevel:
#        runspe = False
#elif deriv >= 1:
...
EV_HARTREE = 0.03674932217565499
# (conversion ref: 2018 CODATA NIST)
